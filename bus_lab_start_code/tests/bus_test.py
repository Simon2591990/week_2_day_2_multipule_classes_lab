...
class TestBus(unittest.TestCase):
    ...
    def test_can_pick_up_passenger_from_bus_stop(self):
        ...
        person_2 = Person("Carol Willing", 50, "The Moon")
    ...
    def test_can_pick_up_passenger__on_same_route(self):
        person_1 = Person("Guido van Rossum", 64, "Ocean Terminal")
        person_2 = Person("Carol Willing", 50, "The Moon")
        person_3 = Person("Simon", 30, "Leith")
        person_4 = Person("Stan", 29, "Mars")
        bus_stop = BusStop("Waverly Station")
        bus_stop.add_to_queue(person_1)
        bus_stop.add_to_queue(person_2)
    ...
    def test_can_pick_up_multiple_people(self):
        person_1 = Person("Guido van Rossum", 64, "Ocean Terminal")
        person_2 = Person("Carol Willing", 50, "The Moon")
        person_3 = Person("Simon", 30, "Leith")
        person_4 = Person("Stan", 29, "Mars")
        ...
        bus_stop = BusStop("Waverly Station")
        bus_stop.add_people_to_queue(people)
